...
namespace AC
{
	...
	public class AmbienceStorageWindow : SoundtrackStorageWindow
	{
		...
		protected void OnGUI ()
		{
			...
			{
				KickStarter.settingsManager.playAmbienceWhilePaused = EditorGUILayout.ToggleLeft ("Ambience can play when game is paused?", KickStarter.settingsManager.playAmbienceWhilePaused);
